...
def test_module_uninstall_accepts_multiple_names() -> None:
    ...
    with (
        ...
        patch(
            "specfact_cli.modules.module_registry.src.commands.discover_all_modules",
            return_value=[
                type("E", (), {"metadata": type("M", (), {"name": "specfact-codebase"})(), "source": "marketplace"})(),
                type(
                    "E", (), {"metadata": type("M", (), {"name": "specfact-code-review"})(), "source": "marketplace"}
                )(),
            ],
        ),
    ):
...
def test_module_uninstall_multi_missing_first_reports_error_still_uninstalls_rest_exits_nonzero() -> None:
    ...
    discovered = [
        type("E", (), {"metadata": type("M", (), {"name": "specfact-code-review"})(), "source": "marketplace"})(),
    ]
