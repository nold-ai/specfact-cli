...
class TestPlanComparator:
    ...
    def test_identical_plans_no_deviations(self):
        ...
        plan1 = PlanBundle(version="1.0", idea=idea, business=None, product=product, features=[feature], metadata=None)

        plan2 = PlanBundle(version="1.0", idea=idea, business=None, product=product, features=[feature], metadata=None)
    ...
    def test_missing_feature_in_auto_plan(self):
        ...
        auto_plan = PlanBundle(version="1.0", idea=idea, business=None, product=product, features=[feature1], metadata=None)
    ...
    def test_extra_feature_in_auto_plan(self):
        ...
        manual_plan = PlanBundle(version="1.0", idea=idea, business=None, product=product, features=[feature1], metadata=None)

        auto_plan = PlanBundle(version="1.0", idea=idea, business=None, product=product, features=[feature1, feature2], metadata=None)
    ...
    def test_modified_feature_title(self):
        ...
        manual_plan = PlanBundle(version="1.0", idea=idea, business=None, product=product, features=[feature_manual], metadata=None)

        auto_plan = PlanBundle(version="1.0", idea=idea, business=None, product=product, features=[feature_auto], metadata=None)
    ...
    def test_idea_mismatch(self):
        ...
        manual_plan = PlanBundle(version="1.0", idea=idea1, business=None, product=product, features=[], metadata=None)

        auto_plan = PlanBundle(version="1.0", idea=idea2, business=None, product=product, features=[], metadata=None)
    ...
    def test_product_theme_differences(self):
        ...
        manual_plan = PlanBundle(version="1.0", idea=idea, business=None, product=product1, features=[], metadata=None)

        auto_plan = PlanBundle(version="1.0", idea=idea, business=None, product=product2, features=[], metadata=None)
    ...
    def test_business_context_missing(self):
        ...
        manual_plan = PlanBundle(version="1.0", idea=idea, business=business, product=product, features=[], metadata=None)

        auto_plan = PlanBundle(version="1.0", idea=idea, business=None, product=product, features=[], metadata=None)
    ...
    def test_compare_with_custom_labels(self):
        ...
        manual_plan = PlanBundle(version="1.0", idea=idea, business=None, product=product, features=[], metadata=None)
    ...
    def test_multiple_deviation_types(self):
        ...
        manual_plan = PlanBundle(version="1.0", idea=idea1, business=None, product=product1, features=[feature1], metadata=None)

        auto_plan = PlanBundle(
            version="1.0", idea=idea2, business=None, product=product2, features=[feature1, feature2], metadata=None
        )
