...
from specfact_cli.commands.backlog_commands import _fetch_backlog_items
...
class TestBacklogRefineLimitAndCancel:
    ...
    def test_fetch_backlog_items_respects_limit(self) -> None:
        ...
        with patch("specfact_cli.commands.backlog_commands.AdapterRegistry") as mock_registry:
