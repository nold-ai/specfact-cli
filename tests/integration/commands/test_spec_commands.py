...
class TestSpecValidateCommand:
    ...
    @patch("specfact_spec.spec.commands.check_specmatic_available")
    @patch("specfact_spec.spec.commands.validate_spec_with_specmatic")
...
class TestSpecBackwardCompatCommand:
    ...
    @patch("specfact_spec.spec.commands.check_specmatic_available")
    @patch("specfact_spec.spec.commands.check_backward_compatibility")
...
class TestSpecGenerateTestsCommand:
    ...
    @patch("specfact_spec.spec.commands.check_specmatic_available")
    @patch("specfact_spec.spec.commands.generate_specmatic_tests")
...
class TestSpecMockCommand:
    ...
    @patch("specfact_spec.spec.commands.check_specmatic_available")
    @patch("specfact_spec.spec.commands.create_mock_server")
