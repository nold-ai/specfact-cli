...
Define how Requirements runtime evidence retains a failing-first proof and binds
it to immutable source, test, plan, and toolchain provenance before a later
verified reconciliation can rely on it.
