...
| 7 | `requirements-08-bounded-red-green-proof` | - | Replay an explicit B < R < H checkpoint and attest only the declared selector/path transition | corrected modules R08 signed immutable release and fixture; R07 current-run boundary |
