...
| 7 | `requirements-08-bounded-red-green-proof` | - | Replay B < R < H, bind delivered head D, and attest only declared implementation plus post-green evidence transitions | corrected modules R08 signed immutable B/R/H/D capsule release and fixture; R07 current-run boundary |
