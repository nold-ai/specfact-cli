...
- **Affected specs**: New `openspec/changes/backlog-04-sprint-planning-capacity-commitment-support/specs/sprint-planning/spec.md` (Given/When/Then for capacity config, commitment sum, over/under output).
