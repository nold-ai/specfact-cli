...
- **Affected specs**: New `openspec/changes/backlog-09-definition-of-done-support/specs/definition-of-done/spec.md` (Given/When/Then for DoD config, validation, status output).
