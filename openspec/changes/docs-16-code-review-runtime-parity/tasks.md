...
Historical implementation and verification from PR #729 are recorded in TDD_EVIDENCE.md. The prospective re-delivery has separate completion status.

- [x] 1.1 Verify unchanged public dev, preserve PR729 history, and confirm scoped public issue #728 authorization.
...
- [ ] 3.4 Complete protected integration; archive with OpenSpec CLI only after acceptance.
