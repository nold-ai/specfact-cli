...
- [x] 4.1 Create bundled `SKILL.md` in `specfact-code-review` package at
  `src/specfact_code_review/resources/skills/specfact-code-review/SKILL.md`:
  ...
  - [x] 4.1.6 `rules init` copies from bundled template and mirrors to `.cursor/rules/house_rules.mdc`
