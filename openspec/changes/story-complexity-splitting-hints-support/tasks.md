...
- [ ] 1.2 Create branch with Development link to issue (if exists): `gh issue develop 171 --repo nold-ai/specfact-cli --name feature/story-complexity-splitting-hints-support --checkout`
- [ ] 1.3 Or create branch without issue link: `git checkout -b feature/story-complexity-splitting-hints-support` (if no issue yet)
