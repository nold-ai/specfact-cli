...
## Workflow additions — 2026-09-20

Added planning/Todo stories core #742 (parent #372) and modules #483 (parent #163), both assigned to djm81 in SpecFact CLI. Native edges are modules #481 -> modules #483 -> core #742. The second edge gates runtime adoption; core projection can proceed independently. R09 is upstream, never blocked on the new consumer. Generic #251/#253, optional preflight, graph/governance and parked taxonomy remain related rather than new blanket blockers. Workflow operational state does not expand R09's evidence contract, and no current runtime or required policy changes in this amendment.
