...
Changed Python paths that are absent from the checked-out head, including
deletions already authenticated by Requirements diff reconciliation, SHALL be
filtered consistently with the accepted R07 file-oriented review contract.
