...
- [x] 5.4 Update `CHANGELOG.md` and apply the required patch-version bump if this docs fix ships as a releaseable change
- [x] 5.5 Open PR to `dev` from `feature/docs-03-command-syntax-parity`
