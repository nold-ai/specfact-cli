...
- [ ] 1.2 Create branch linked to #175: `gh issue develop 175 --repo nold-ai/specfact-cli --name feature/backlog-scrum-01-standup-exceptions-first --checkout` (or `git checkout -b feature/backlog-scrum-01-standup-exceptions-first` if no gh)
