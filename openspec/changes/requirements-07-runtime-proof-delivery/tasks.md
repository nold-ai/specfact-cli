...
- `openspec/changes/requirements-07-runtime-proof-delivery/requirements-evidence.yaml`: before production edits only, remap `R07-CORE-008-S01` and convert `R07-CORE-009-S01`/`R07-CORE-009-S02` to the three exact selectors named in task 2.5, verify collection, and freeze the accepted mapping/plan digests.
