...
- **Affected specs**: New `openspec/changes/patch-01-patch-mode-preview-apply/specs/patch-mode/spec.md` (Given/When/Then for patch generation, apply local, write upstream).
