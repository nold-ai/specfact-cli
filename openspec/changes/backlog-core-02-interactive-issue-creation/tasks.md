...
- [ ] 1.2 Create branch with Development link to issue (if exists): `gh issue develop 173 --repo nold-ai/specfact-cli --name feature/backlog-core-02-interactive-issue-creation --checkout`
- [ ] 1.3 Or create branch without issue link: `git checkout -b feature/backlog-core-02-interactive-issue-creation` (if no issue yet)
