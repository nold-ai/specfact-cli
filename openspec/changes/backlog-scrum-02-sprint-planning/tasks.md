...
- [ ] 1.2 Create branch with Development link to issue (if exists): `gh issue develop 170 --repo nold-ai/specfact-cli --name feature/backlog-scrum-02-sprint-planning --checkout`
- [ ] 1.3 Or create branch without issue link: `git checkout -b feature/backlog-scrum-02-sprint-planning` (if no issue yet)
