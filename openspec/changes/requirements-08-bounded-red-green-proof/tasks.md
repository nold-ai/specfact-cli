...
- `tests/unit/scripts/test_requirements_proof_provenance.py`: replace obsolete static-closure cases with B/R/H/D ancestry/delivery identity, protected signed checkpoint authority, three path-set, frozen-ledger-section preservation, missing-history/artifact, rename, attestation, and bootstrap cases.
