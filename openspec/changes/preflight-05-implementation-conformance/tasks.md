...
- [ ] 2.2 Add tests mapped to every worktree/index/range identity, authority-separation, path-transition, checkpoint-subset and exhaustive final-obligation closure, finding-class/precedence (including the reconciled semantic `violated` scenario), stale-seal, evidence, and assurance-limit scenario.
