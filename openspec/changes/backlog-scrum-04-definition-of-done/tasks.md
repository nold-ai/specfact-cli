...
- [ ] 1.2 Create branch with Development link to issue (if exists): `gh issue develop <issue-number> --repo nold-ai/specfact-cli --name feature/backlog-scrum-04-definition-of-done --checkout`
- [ ] 1.3 Or create branch without issue link: `git checkout -b feature/backlog-scrum-04-definition-of-done` (if no issue yet)
