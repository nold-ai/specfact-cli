...
2. **AI calls SpecFact CLI** (`specfact project import from-code <bundle-name>`) for structured analysis
...
```mermaid
flowchart TD
    A["code2spec Command<br/>specfact project import from-code my-project --repo . --confidence 0.5"] --> B{Operational Mode}
