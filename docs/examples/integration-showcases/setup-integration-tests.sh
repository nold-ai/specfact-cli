...
echo "  4. Open test file in IDE and use slash command: /specfact.01-import legacy-api --repo ."
echo "     (Interactive mode automatically uses IDE workspace - --repo . optional)"
echo ""
echo "📚 Documentation:"
